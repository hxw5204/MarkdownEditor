...
import { EditorContext, PreviewType, ContextStore } from '../../model/Context';
import { ICommand } from '../../parser';
    ...
    return (
        <ul>
            {(props.commands || []).map((item, idx) =>
            {
                ...
                {
                    return <li key={idx} {...item.liProps} className="_toolbar-divider" />;
                }
...
export default function Toolbar(props: IToolbarProps = {})
{
    ...
    return (
        <div className="_toolbar" style={{ height }}>
